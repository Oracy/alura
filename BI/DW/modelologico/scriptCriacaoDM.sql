...
ALTER TABLE Dim_Fabrica COMMENT 'Tabela de dimensao Fabrica';
...
ALTER TABLE Dim_Cliente COMMENT 'Tabela da dimensao cliente';


CREATE TABLE Fato_da_Presidencia (
                ID_Vendedor INT NOT NULL,
                ID_Fabrica INT NOT NULL,
                ID_Tempo INT NOT NULL,
                ID_Cliente INT NOT NULL,
                ...
                PRIMARY KEY (ID_Vendedor, ID_Fabrica, ID_Tempo, ID_Cliente, ID_Produto)
);


ALTER TABLE Fato_da_Presidencia ADD CONSTRAINT dim_organizacional_fato_da_presidencia_fk
FOREIGN KEY (ID_Vendedor)
REFERENCES Dim_Organizacional (ID_Vendedor)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE Fato_da_Presidencia ADD CONSTRAINT produto_fato_da_presidencia_fk
FOREIGN KEY (ID_Produto)
REFERENCES Dim_Produto (ID_Produto)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE Fato_da_Presidencia ADD CONSTRAINT tempo_fato_da_presidencia_fk
FOREIGN KEY (ID_Tempo)
REFERENCES Dim_Tempo (ID_Tempo)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE Fato_da_Presidencia ADD CONSTRAINT fabrica_fato_da_presidencia_fk
FOREIGN KEY (ID_Fabrica)
REFERENCES Dim_Fabrica (ID_Fabrica)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE Fato_da_Presidencia ADD CONSTRAINT cliente_fato_da_presidencia_fk
